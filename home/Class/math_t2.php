			...
			<section id="banner">
				<div class="inner">
					...
					<div class="flex ">
						...
						<div>
							<span class="icon fa-sort-numeric-asc"></span>
							<h3><a href="#home/class/math.php">MULTIPLICATION</a></h3>

						</div>

						<div>
							<span class="icon fa-plus"></span>
							<h3><a href="add_t.php">ADDITION</a></h3>
            </div>
              <div>
  							<span class="icon fa-minus"></span>
  							<h3><a href="#class/eng.php">SUBTRACTION</a></h3>
